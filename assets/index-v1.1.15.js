  ...
  return (
    w.useEffect(() => {
      ...
      return (
        (async () => {
          const N = await _f(
            () => import("./leaflet-v1.1.15.js").then((D) => D.l),
            [],
            import.meta.url,
          );
    ...
    w.useEffect(() => {
      !d.current ||
        ...
        (async () => {
          const C = await _f(
            () => import("./leaflet-v1.1.15.js").then((N) => N.l),
            [],
            import.meta.url,
          );
  ...
  return (
    ...
    w.useEffect(() => {
      ...
      return (
        (async () => {
          const N = await _f(
            () => import("./leaflet-v1.1.15.js").then((O) => O.l),
            [],
            import.meta.url,
          );
        ...
        children: [
          ...
          f.jsxs("div", {
            children: [
              ...
              f.jsx("small", { children: "APP METEO LOCALE · v1.1.15" }),
            ],
          }),
          f.jsx("button", {
            className: "info",
          ...
          children: [
            ...
            f.jsxs("div", {
              children: [
                ...
                f.jsx("strong", { children: "Grandine Alert 1.1.15" }),
                f.jsx("p", {
                  children:
                    "Ora puoi passare tra Radar e Rischio anche con uno swipe orizzontale, oltre ai pulsanti inferiori.",
                }),
              ],
            }),
            f.jsx("button", {
        ...
        children: [
          f.jsxs("div", {
            ...
            children: [
              ...
              f.jsx("span", { children: "Versione 1.1.15" }),
