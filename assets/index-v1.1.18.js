...
async function b0(S, M) {
  ...
  for (let Sl = 1; Sl < C.height; Sl += 2)
    for (let pl = 1; pl < C.width; pl += 2) {
      ...
      if (!hl) continue;
      (jl < R && ((R = jl), (nearestX = pl), (nearestY = Sl)),
        (J = Math.max(J, hl)),
        (counts[hl] += 1));
      const K = hl * hl;
      ((al += pl * K), (cl += Sl * K), (I += K));
...
async function Ld(S, M) {
  ...
  try {
    const j = await Promise.all(S.map((jl) => b0(jl, M))),
      d = j
        .map((jl, il) => ({ sample: jl, index: il }))
        .filter((jl) => jl.sample !== null);
    if (!d.length)
      return {
        available: !0,
        distance: null,
  ...
  return (
    w.useEffect(() => {
      ...
      return (
        (async () => {
          const N = await _f(
            () => import("./leaflet-v1.1.18.js").then((D) => D.l),
            [],
            import.meta.url,
          );
    ...
    w.useEffect(() => {
      !d.current ||
        ...
        (async () => {
          const C = await _f(
            () => import("./leaflet-v1.1.18.js").then((N) => N.l),
            [],
            import.meta.url,
          );
  ...
  return (
    ...
    w.useEffect(() => {
      ...
      return (
        (async () => {
          const N = await _f(
            () => import("./leaflet-v1.1.18.js").then((O) => O.l),
            [],
            import.meta.url,
          );
        ...
        children: [
          ...
          f.jsxs("div", {
            children: [
              ...
              f.jsx("small", { children: "APP METEO LOCALE · v1.1.18" }),
            ],
          }),
          f.jsx("button", {
          ...
          children: [
            ...
            f.jsxs("div", {
              children: [
                ...
                f.jsx("strong", { children: "Grandine Alert 1.1.18" }),
                f.jsx("p", {
                  children:
        ...
        children: [
          f.jsxs("div", {
            ...
            children: [
              ...
              f.jsx("span", { children: "Versione 1.1.18" }),
