  ...
  return (
    w.useEffect(() => {
      ...
      return (
        (async () => {
          const N = await _f(
            () => import("./leaflet-v1.1.11.js").then((D) => D.l),
            [],
            import.meta.url,
          );
    ...
    w.useEffect(() => {
      !d.current ||
        ...
        (async () => {
          const C = await _f(
            () => import("./leaflet-v1.1.11.js").then((N) => N.l),
            [],
            import.meta.url,
          );
  ...
  return (
    ...
    w.useEffect(() => {
      ...
      return (
        (async () => {
          const N = await _f(
            () => import("./leaflet-v1.1.11.js").then((O) => O.l),
            [],
            import.meta.url,
          );
...
function x0() {
  ...
  const Qe = () => {
    ...
    ci = async () => {
      ...
      window.location.href = `./?update=${Bl?.latest ?? Nf}&t=${Date.now()}`;
    };
  return f.jsxs("main", {
    children: [
      f.jsxs("header", {
        children: [
          ...
          f.jsxs("div", {
            children: [
              ...
              f.jsx("small", { children: "APP METEO LOCALE · v1.1.11" }),
            ],
          }),
          f.jsx("button", {
            className: "info",
          ...
          children: [
            ...
            f.jsxs("div", {
              children: [
                ...
                f.jsx("strong", { children: "Grandine Alert 1.1.11" }),
                f.jsx("p", {
                  children:
      ...
      S === "radar"
        ...
        : f.jsxs("div", {
            ...
            children: [
              ...
              x &&
                f.jsx(Qd, { title: "Fenomeni intorno all’auto", analysis: Le }),
            ],
          }),
      f.jsxs("footer", {
        children: [
          f.jsxs("div", {
            ...
            children: [
              f.jsx("div", {
                ...
                role: "img",
                "aria-label": "Monogramma GF",
              }),
              f.jsxs("div", {
                className: "signatureText",
                children: [
                  f.jsx("strong", { children: "Grandine Alert" }),
              f.jsx("span", { children: "Versione 1.1.11" }),
