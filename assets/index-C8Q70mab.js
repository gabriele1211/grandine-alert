  ...
  return (
    w.useEffect(() => {
      ...
      return (
        (async () => {
          const N = await _f(
            () => import("./leaflet-src-wmR1-sjr.js").then((D) => D.l),
            [],
            import.meta.url,
          );
    ...
    w.useEffect(() => {
      !d.current ||
        ...
        (async () => {
          const C = await _f(
            () => import("./leaflet-src-wmR1-sjr.js").then((N) => N.l),
            [],
            import.meta.url,
          );
  ...
  return (
    ...
    w.useEffect(() => {
      ...
      return (
        (async () => {
          const N = await _f(
            () => import("./leaflet-src-wmR1-sjr.js").then((O) => O.l),
            [],
            import.meta.url,
          );
...
function x0() {
  ...
  const Qe = () => {
    ...
    ci = async () => {
      ...
      window.location.replace(`./?version=${Bl?.latest ?? Date.now()}`);
    };
  return f.jsxs("main", {
    children: [
      f.jsxs("header", {
