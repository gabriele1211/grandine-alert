    ...
    if (lastIndex >= 0) {
      for (const lastSample of j[lastIndex]) {
        ...
        const oldest = track[0].sample,
          ...
          direct = track.length >= 3 && approaching && projection > 0 && closestKm <= 15,
          near = track.length >= 3 && projection > 0 && closestKm <= 30,
          relevance =
            (direct ? 20000 : near ? 10000 : approaching ? 5000 : 0) +
  ...
  return (
    w.useEffect(() => {
      ...
      return (
        (async () => {
          const N = await _f(
            () => import("./leaflet-v1.1.22.js").then((D) => D.l),
            [],
            import.meta.url,
          );
    ...
    w.useEffect(() => {
      !d.current ||
        ...
        (async () => {
          const C = await _f(
            () => import("./leaflet-v1.1.22.js").then((N) => N.l),
            [],
            import.meta.url,
          );
  ...
  return (
    ...
    w.useEffect(() => {
      ...
      return (
        (async () => {
          const N = await _f(
            () => import("./leaflet-v1.1.22.js").then((O) => O.l),
            [],
            import.meta.url,
          );
        ...
        children: [
          ...
          f.jsxs("div", {
            children: [
              ...
              f.jsx("small", { children: "APP METEO LOCALE · v1.1.22" }),
            ],
          }),
          f.jsx("button", {
          ...
          children: [
            ...
            f.jsxs("div", {
              children: [
                ...
                f.jsx("strong", { children: "Grandine Alert 1.1.22" }),
                f.jsx("p", {
                  children:
        ...
        children: [
          f.jsxs("div", {
            ...
            children: [
              ...
              f.jsx("span", { children: "Versione 1.1.22" }),
